        ...
        return class extends constructor {
            ...
            [_transformer] = <L extends Object>(
                ...
                return Object.fromEntries(
                    iterate(option?.skipId === true ? __columnsNoId : __columns)
...
export class SqlService<T extends object> {
    ...
    */
        ...
        switch (templateResult) {
            ...
            case SelectResult.RS_CS: {
                if (mapper) {
                    ...
                    return iterate(result).map((r: any) => C2P2(r) as L).toArray();
                } else {
                    return result as L[];
                }
            }
            ...
            case SelectResult.RS_CS_List: {
                if (mapper) {
                    return new ArrayList<L>(iterate(result).map((data: any) => flatData<L>({ data, mapper, mapperIfUndefined })).toArray());
                } else if (hump === true || (hump === undefined && globalThis[_Hump] === true)) {
                    return new ArrayList<L>(iterate(result).map((r: any) => C2P2(r) as L).toArray());
                } else {
                    return new ArrayList<L>();
                }
            }
    ...
    page<L = T>(option: MethodOption & { sync?: SyncMode.Async; sqlId: string; context?: any; params: Record<string, any>; pageSize?: number; pageNumber?: number; limitSelf?: boolean; countSelf?: boolean; sumSelf?: boolean; sortName?: string; sortType?: string; hump?: boolean; mapper?: string | SqlMapper; mapperIfUndefined?: MapperIfUndefined; }): Promise<PageQuery<L>>;
    page<L = T>(option: MethodOption & { sync: SyncMode.Sync; sqlId: string; context?: any; params: Record<string, any>; pageSize?: number; pageNumber?: number; limitSelf?: boolean; countSelf?: boolean; sumSelf?: boolean; sortName?: string; sortType?: string; hump?: boolean; mapper?: string | SqlMapper; mapperIfUndefined?: MapperIfUndefined; }): PageQuery<L>;
    @P<T>()
    page<L = T>(option: MethodOption & { sync?: SyncMode; sqlId: string; context?: any; params: Record<string, any>; pageSize?: number; pageNumber?: number; limitSelf?: boolean; countSelf?: boolean; sumSelf?: boolean; sortName?: string; sortType?: string; hump?: boolean; mapper?: string | SqlMapper; mapperIfUndefined?: MapperIfUndefined; }): PageQuery<L> | Promise<PageQuery<L>> {
...
class StreamQuery<T extends object> {
    ...
    @IF_PROCEED<T>()
    eqs(keys: (keyof T)[], value: string | number, { paramName = '', skipEmptyString = true, breakExcuteIfSkip = false } = {}) { return this.__(keys, value, '=', { paramName, skipEmptyString, breakExcuteIfSkip }); }
    @IF_PROCEED<T>()
    ...
    @IF_PROCEED<T>()
    in2(key: (keyof T)[], value: string | number, { paramName = '', breakExcuteIfSkip = false } = {}) { return this._in2(key, value, { paramName, breakExcuteIfSkip }); }
    @IF_PROCEED<T>()
    notIn2(key: (keyof T)[], value: string | number, { paramName = '', skipEmptyString = true, breakExcuteIfSkip = false } = {}) { return this._in2(key, value, { paramName, skipEmptyString, not: 'NOT', breakExcuteIfSkip }); }
    @IF_PROCEED<T>()
    ...
    private __(keys: (keyof T)[], value: any, op: string, { not = '', paramName = '', skipEmptyString = true, breakExcuteIfSkip = false } = {}) {
        if (
            value === null
            || value === undefined
            || (emptyString(`${value ?? ''}`) && skipEmptyString === true)
    ...
    private _in(key: keyof T, value: Array<string | number>, { not = '', paramName = '', skipEmptyString = true, breakExcuteIfSkip = false } = {}) {
    ...
    private _in2(key: (keyof T)[], value: any, { not = '', paramName = '', skipEmptyString = true, breakExcuteIfSkip = false } = {}) {
